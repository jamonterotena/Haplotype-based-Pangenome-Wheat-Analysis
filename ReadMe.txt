- functions_hbpa.r is required by any other script in this repository. Most functions were based on those by Brinton et al (2020), of which some were modified for the script purpose or aesthetically, meanwhile some functions are completely original
