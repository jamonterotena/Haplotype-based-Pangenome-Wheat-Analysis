...
print("1.2.6. Dot-plot the zoom region with the haploblock predictions and the target region and make decisions regarding the start and end limits of the sequence-based haploblock. Check plots")
...
print("If coordinates have been provided at this point, the pipeline will not continue")
...
print("2.2. Read the gff file containing the gene model projection for the reference assembly")
